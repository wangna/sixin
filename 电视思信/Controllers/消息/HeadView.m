...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [btn setBackgroundImage:[UIImage imageNamed:@"color1.png"] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:@"color1.png"] forState:UIControlStateHighlighted];
        [self addSubview:btn];
