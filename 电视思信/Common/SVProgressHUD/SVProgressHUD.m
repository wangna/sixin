...
+ (void)showAbnormalThenDismiss:(NSString *)string{
    [SVProgressHUD show];
    [SVProgressHUD dismissWithImageType:SVProgressHUDImageAbnormal info:string];
}

+ (void)showNormalThenDismiss:(NSString *)string{
    [SVProgressHUD show];
    [SVProgressHUD dismissWithImageType:SVProgressHUDImageNormal info:string];
}
...
+ (void)dismissWithImageType:(SVProgressHUDImageType)imageType info:(NSString *)errorString{
    [[SVProgressHUD sharedView] dismissWithStatus:errorString imageType:imageType afterDelay:0.9];
}


- (void)dismissWithStatus:(NSString *)string imageType:(SVProgressHUDImageType)imageType afterDelay:(NSTimeInterval)seconds {
    [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
	
	if(imageType==SVProgressHUDImageNormal)
		self.imageView.image = [UIImage imageNamed:@"SVProgressHUD.bundle/icon_smile_face.png"];
	else if(imageType==SVProgressHUDImageAbnormal)
		self.imageView.image = [UIImage imageNamed:@"SVProgressHUD.bundle/icon_sad_face.png"];
